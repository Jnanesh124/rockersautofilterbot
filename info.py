...
#main variables
API_ID = int(environ.get('API_ID', '2916'))
API_HASH = environ.get('API_HASH', 'c4c1cf7980454984')
BOT_TOKEN = environ.get('BOT_TOKEN', '732774vnOe8pj7a-Fzs7_4')
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "3daf41670bf9ee8030e786aed791f15ffb7eb104")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'Seturl.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "3daf41670bf9ee8030e786aed791f15ffb7eb104")
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002071799763')
...
DELETE_TIME = int(environ.get('DELETE_TIME', 80))
